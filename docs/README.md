...
Use this page as the entry point before jumping into feature-specific docs.
...
- [Comprehensive Testing Plan](../plans/comprehensive-testing-suite.md): Cross-repo testing strategy and quality goals.
...
- [Automation/Agent Instructions](../AGENTS.md): Repository-specific agent workflow requirements.
- [Contributor Working Notes](../CLAUDE.md): Build/test commands and architecture notes for coding agents.
